...
RSpec.describe 'api/calculator/calculations/create.json.jbuilder', type: :view do
  ...
  context 'calculation top level object' do
    let(:calculation) { instance_double(::Calculator::CalculationService, help_not_available?: false, help_available?: false, inputs: inputs, failure_reasons: [], fields_required: fields_required) }
  ...
  context 'calculation.result.should_get_help' do
    ...
    context 'when calculation.help_available is true' do
      ...
      let(:calculation) { instance_double(::Calculator::CalculationService, help_not_available?: false, help_available?: true, inputs: inputs, failure_reasons: [], fields_required: fields_required) }
      it 'is true' do
        json = JSON.parse(rendered)
  ...
  context 'calculation.result.should_not_get_help' do
    ...
    context 'when calculation.help_not_available? is true' do
      let(:calculation) { instance_double(::Calculator::CalculationService, help_not_available?: true, help_available?: false, inputs: inputs, failure_reasons: [], fields_required: fields_required) }
  ...
  context 'calculation.result.messages' do
    ...
    context 'when calculation.help_not_available? is true and failure_reasons are present' do
      let(:calculation) { instance_double(::Calculator::CalculationService, help_not_available?: true, help_available?: false, inputs: inputs, failure_reasons: [:any_reason, :any_other_reason], fields_required: fields_required) }
